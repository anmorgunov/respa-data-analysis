...
\makeatother
% \rfoot{Стр. \thepage}
\fancyfoot[LE,RO]{Стр. \thepage/24}
\fancyfoot[RE,LO]{qazcho.kz}
...
% \input{tex/participants}

% \chapter{Вопросы логистики}
% \input{tex/logistics}

% \chapter{Вопросы подготовки заданий}
% \input{tex/problemprep}
